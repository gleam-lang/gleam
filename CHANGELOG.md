...
- The GitHub Actions workflow generated by `gleam new` now sets
  `permissions: contents: read`, restricting the default token's access
  down from GitHub's broad implicit default.
  ([Bryan Saravia](https://github.com/Bryandero98))
