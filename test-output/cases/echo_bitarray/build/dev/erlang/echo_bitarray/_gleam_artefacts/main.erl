...
-file("/Users/giacomocavalieri/Documents/progetti/gleam/test-output/cases/echo_bitarray/src/main.gleam", 8).
-spec target_specific() -> bitstring().
target_specific() ->
    echo(<<1, 2, 3:2>>, "src/main.gleam", 10).

-file("/Users/giacomocavalieri/Documents/progetti/gleam/test-output/cases/echo_bitarray/src/main.gleam", 1).
-spec main() -> bitstring().
main() ->
    echo(<<>>, "src/main.gleam", 2),
    echo(<<1, 2, 3>>, "src/main.gleam", 3),
    target_specific().
