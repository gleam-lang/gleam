...
-file("/Users/giacomocavalieri/Documents/progetti/gleam/test-output/cases/echo_bool/src/main.gleam", 1).
-spec main() -> boolean().
main() ->
    echo(true, "src/main.gleam", 2),
    echo(false, "src/main.gleam", 3).
