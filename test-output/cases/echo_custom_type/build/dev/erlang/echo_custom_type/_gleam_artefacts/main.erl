...
-type wibble() :: {wibble, integer(), binary()} | {wobble, list(float())} | woo.

-file("/Users/giacomocavalieri/Documents/progetti/gleam/test-output/cases/echo_custom_type/src/main.gleam", 7).
-spec main() -> wibble().
main() ->
    echo({wibble, 1, <<"hello"/utf8>>}, "src/main.gleam", 8),
    echo({wobble, [1.0, 1.1]}, "src/main.gleam", 9),
    echo(woo, "src/main.gleam", 10).
