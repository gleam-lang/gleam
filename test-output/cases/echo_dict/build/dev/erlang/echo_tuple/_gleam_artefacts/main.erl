...
-file("/Users/giacomocavalieri/Documents/progetti/gleam/test-output/cases/echo_dict/src/main.gleam", 3).
-spec main() -> gleam@dict:dict(integer(), binary()).
main() ->
    echo(gleam@dict:new(), "src/main.gleam", 4),
    echo(
        maps:from_list([{1, <<"hello"/utf8>>}, {2, <<"world!"/utf8>>}]),
        "src/main.gleam",
        5
    ).
