...
-export([target_specific/0, main/0]).
-export_type([wibble/0]).

-type wibble() :: wibble.

-file("/Users/giacomocavalieri/Documents/progetti/gleam/test-output/cases/echo_tuple/src/main.gleam", 13).
-spec target_specific() -> {wibble(), integer(), binary()}.
target_specific() ->
    echo({wibble, 1, <<"hello"/utf8>>}, "src/main.gleam", 16).

-file("/Users/giacomocavalieri/Documents/progetti/gleam/test-output/cases/echo_tuple/src/main.gleam", 1).
-spec main() -> {wibble(), integer(), binary()}.
main() ->
    echo({}, "src/main.gleam", 2),
    echo({true, 1, <<"hello"/utf8>>}, "src/main.gleam", 3),
    target_specific().
