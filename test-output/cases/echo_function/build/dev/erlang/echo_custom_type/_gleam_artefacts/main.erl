...
-file("/Users/giacomocavalieri/Documents/progetti/gleam/test-output/cases/echo_function/src/main.gleam", 6).
-spec private() -> integer().
private() ->
    1.

-file("/Users/giacomocavalieri/Documents/progetti/gleam/test-output/cases/echo_function/src/main.gleam", 1).
-spec main() -> fun(() -> integer()).
main() ->
    echo(fun(N) -> N + 1 end, "src/main.gleam", 2),
    echo(fun private/0, "src/main.gleam", 3).
