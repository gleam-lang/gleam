...
-file("/Users/giacomocavalieri/Documents/progetti/gleam/test-output/cases/echo_string/src/main.gleam", 1).
-spec main() -> binary().
main() ->
    echo(<<"hello world"/utf8>>, "src/main.gleam", 2),
    echo(<<"multiline
string"/utf8>>, "src/main.gleam", 3),
    echo(<<"string with\t\r\nescaped chars"/utf8>>, "src/main.gleam", 5).
