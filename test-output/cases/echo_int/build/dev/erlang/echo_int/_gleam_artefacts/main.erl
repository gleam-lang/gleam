...
-file("/Users/giacomocavalieri/Documents/progetti/gleam/test-output/cases/echo_int/src/main.gleam", 1).
-spec main() -> integer().
main() ->
    echo(1, "src/main.gleam", 2),
    echo(2, "src/main.gleam", 3),
    echo(100000, "src/main.gleam", 4).
