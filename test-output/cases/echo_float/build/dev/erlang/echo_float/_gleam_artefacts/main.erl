...
-file("/Users/giacomocavalieri/Documents/progetti/gleam/test-output/cases/echo_float/src/main.gleam", 1).
-spec main() -> float().
main() ->
    echo(1.0, "src/main.gleam", 2),
    echo(2.1, "src/main.gleam", 3),
    echo(11.11, "src/main.gleam", 4).
