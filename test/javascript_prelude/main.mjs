...
assertThrows("`BitArray.slice()` throw if start is less than zero", () =>
...
assertThrows("`BitArray.slice()` throw if end is before start", () =>
...
assertEqual(sliceToFloat([63, 240, 0, 0, 0, 0, 0, 0], 64, 0, 64, true), 1.0);
assertEqual(sliceToFloat([0, 0, 0, 0, 0, 0, 240, 63], 64, 0, 64, false), 1.0);
assertEqual(
...
assertEqual(testSliceToInt([0xff, 0xb6, 0xe3], 24, 8, 20, true, false), 0xb6e);
assertEqual(testSliceToInt([0xff, 0xb6, 0xe3], 24, 20, 24, true, false), 0x03);
assertEqual(testSliceToInt([0xff, 0xb6, 0xe3], 24, 8, 20, false, false), 0xeb6);
assertEqual(testSliceToInt([0xa5, 0x6c, 0xaa], 24, 5, 18, true, false), 5554);
assertEqual(testSliceToInt([0xa5, 0x6c, 0xaa], 24, 5, 18, false, true), -3411);
