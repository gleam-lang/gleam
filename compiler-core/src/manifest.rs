...
use crate::{requirement::Requirement, io::MakeRelative};
use crate::Result;
...
#[cfg(test)]
impl MakeRelative for TestMakeRelative {

    // This is a copy of the impl we're using in compiler-cli
...
fn manifest_toml_format() {
    ...
    let buffer = manifest.to_toml(TestMakeRelative { curr_dir: "/home/louis/packages/some_folder".into() });
    assert_eq!(
        buffer,
