        ...
        match (size_value, bits_unit_value) {
            ...
            (
                ...
                Some(unit),
                    ...
                    builder.int(*location, int_value * unit);
            }
        ...
        if let Some(unit) = bits_unit_value {
            ...
            if let TypedExpr::Int { int_value, .. } = &size {
                if int_value.is_negative() {
                    ...
                    builder.int(size.location(), int_value.clone() * unit);
                }
            } else {
                let call = builder.start_remote_call(
                    size.location(),
                ...
                builder.int(size.location(), unit.into());
                builder.end_call(call);
            }
            ...
            if int_value.is_negative() {
                ...
                builder.int(size.location(), int_value.clone());
            }
        } else {
            let call =
