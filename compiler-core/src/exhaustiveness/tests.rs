...
//     assert_eq!(result.missing_patterns(), vec![EcoString::new("_")]);
// }
...
//         )
//     );
//     assert_eq!(result.missing_patterns(), vec![EcoString::new("#(_, _)")]);
// }
...
//         vec![EcoString::new("None"), EcoString::new("Some(_)")]
//     );
// }
...
//     assert_eq!(
//         result.missing_patterns(),
//         vec![EcoString::new("None"), EcoString::new("Some(_, _)")]
//     );
// }
...
//     assert_eq!(result.missing_patterns(), vec![EcoString::new("None")]);
// }
...
//     );
//     assert!(result.diagnostics.missing);
//     assert_eq!(result.missing_patterns(), vec![EcoString::new("[]")]);
// }
