...
#[test]
fn unaligned_int_expression_requires_v1_7() {
    assert_js_warnings_with_gleam_version!(
        Range::higher_than(Version::new(1, 6, 0)),
        "
pub fn main() {
  <<0:1>>
}
...
#[test]
fn bits_expression_does_not_require_v1_7() {
...
#[test]
fn sized_bits_expression_requires_v1_7() {
    assert_js_warnings_with_gleam_version!(
        Range::higher_than(Version::new(1, 6, 0)),
        "
pub fn main() {
...
#[test]
fn unaligned_int_pattern_requires_v1_7() {
    assert_js_warnings_with_gleam_version!(
        Range::higher_than(Version::new(1, 6, 0)),
        "
pub fn main() {
...
#[test]
fn bytes_pattern_with_odd_size_does_not_require_v1_7() {
    assert_js_no_warnings_with_gleam_version!(
        Range::higher_than(Version::new(1, 6, 0)),
        "
pub fn main() {
