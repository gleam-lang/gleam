...
use crate::{
    ...
    ast::{
        ...
        BitArraySegment, CallArg, Clause, ClauseGuard, Constant, HasLocation,
        ImplicitCallArgOrigin, Layer, RecordUpdateSpread, SrcSpan, Statement, TodoKind, TypeAst,
...
impl<'a, 'b> ExprTyper<'a, 'b> {
    ...
    fn infer_const_value(&mut self, value: UntypedConstant) -> Result<TypedConstant, Error> {
        match value {
            Constant::Int { location, value } => Ok(Constant::Int { location, value }),
