...
"#
    ...
    assert_format!(
        "const values = [
  100, 200, 300, 400, 500, 600, 700, 800, 900, 1_000, 1_100, 1_200, 1_300, 1_400,
  1_500, 1_600, 1_700, 1_800, 1_900, 2_000,
]
"
    );
...
fn assignments_break_value_first_test() {
  ...
  assert Ok(1) = [
    ...
    400_000_000_000_000_000_000_000_000_000,
  ]
  Nil
}
"#
    ...
    assert_format!(
        r#"fn main() {
  assert Ok(1) = [
    100_000_000_000_000_000_000_000, 200_000_000_000_000_000_000_000,
    300_000_000_000_000_000_000_000, 400_000_000_000_000_000_000_000,
  ]
  Nil
}
"#
