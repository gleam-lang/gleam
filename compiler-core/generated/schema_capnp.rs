...
pub mod module {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 305] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(149, 2, 0, 0, 130, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        ...
        12 => <crate::schema_capnp::references::Owned as ::capnp::introspect::Introspect>::introspect(),
        _ => panic!("invalid field index {}", index),
      }
    }
    ...
    pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
    pub static MEMBERS_BY_NAME : &[u16] = &[3,11,8,6,0,4,12,9,7,10,1,5,2];
