...
pub mod bad_name {
  ...
  mod _private {
    use capnp::private::layout;
    pub const STRUCT_SIZE: layout::StructSize = layout::StructSize { data: 0, pointers: 2 };
    pub const TYPE_ID: u64 = 0xe60f_6aa9_c6cc_0353;
  }
}
...
pub mod module {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_bad_names(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::schema_capnp::bad_name::Owned>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_bad_names(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::schema_capnp::bad_name::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(7), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_bad_names(&mut self, value: ::capnp::struct_list::Reader<'a,crate::schema_capnp::bad_name::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(7), value, false)
    }
    #[inline]
    pub fn init_bad_names(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::schema_capnp::bad_name::Owned> {
