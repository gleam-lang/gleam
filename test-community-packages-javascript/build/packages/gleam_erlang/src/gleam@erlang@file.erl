...
-export([file_info/1, is_directory/1, is_regular/1, file_exists/1, link_info/1, link_exists/1, make_directory/1, list_directory/1, delete_directory/1, recursive_delete/1, read/1, read_bits/1, write/2, write_bits/2, append/2, append_bits/2, delete/1]).
...
file_info(Field@0) ->
    gleam_erlang_ffi:file_info(Field@0).
...
link_info(Field@0) ->
    gleam_erlang_ffi:link_info(Field@0).
