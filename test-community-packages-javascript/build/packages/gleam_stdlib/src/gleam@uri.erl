...
-export([to_string/1, origin/1, parse/1, parse_query/1, percent_encode/1, query_to_string/1, percent_decode/1, path_segments/1, merge/2]).
-export_type([uri/0]).
...
-spec drop_last(list(EJD)) -> list(EJD).
drop_last(Elements) ->
