...
from_rgb_hex(Hex) ->
    case (Hex > 16#ffffff) orelse (Hex < 0) of
        ...
        false ->
            R = begin
                _pipe = gleam@bitwise:shift_right(Hex, 16),
                gleam@bitwise:'and'(_pipe, 16#ff)
            end,
            G = begin
                _pipe@1 = gleam@bitwise:shift_right(Hex, 8),
                gleam@bitwise:'and'(_pipe@1, 16#ff)
            end,
            B = gleam@bitwise:'and'(Hex, 16#ff),
            from_rgb255(R, G, B)
    end.
    ...
    case (Hex > 16#ffffffff) orelse (Hex < 0) of
        ...
        false ->
            _assert_subject = begin
                _pipe = gleam@bitwise:shift_right(Hex, 24),
                _pipe@1 = gleam@bitwise:'and'(_pipe, 16#ff),
            ...
            _assert_subject@1 = begin
                _pipe@3 = gleam@bitwise:shift_right(Hex, 16),
                _pipe@4 = gleam@bitwise:'and'(_pipe@3, 16#ff),
            ...
            _assert_subject@2 = begin
                _pipe@6 = gleam@bitwise:shift_right(Hex, 8),
                _pipe@7 = gleam@bitwise:'and'(_pipe@6, 16#ff),
            ...
            _assert_subject@3 = begin
                _pipe@9 = gleam@bitwise:'and'(Hex, 16#ff),
...
to_rgba_hex(Colour) ->
    ...
    Red = begin
        ...
        gleam@bitwise:shift_left(_pipe@1, 24)
    end,
    Green = begin
        _pipe@2 = G * 255.0,
        _pipe@3 = gleam@float:round(_pipe@2),
        gleam@bitwise:shift_left(_pipe@3, 16)
    end,
    Blue = begin
        _pipe@4 = B * 255.0,
        _pipe@5 = gleam@float:round(_pipe@4),
        gleam@bitwise:shift_left(_pipe@5, 8)
    end,
    Alpha = begin
        _pipe@6 = A * 255.0,
...
to_rgb_hex(Colour) ->
    ...
    Red = begin
        _pipe = R * 255.0,
        _pipe@1 = gleam@float:round(_pipe),
        gleam@bitwise:shift_left(_pipe@1, 16)
    end,
    Green = begin
        _pipe@2 = G * 255.0,
        _pipe@3 = gleam@float:round(_pipe@2),
        gleam@bitwise:shift_left(_pipe@3, 8)
    end,
    Blue = begin
        _pipe@4 = B * 255.0,
