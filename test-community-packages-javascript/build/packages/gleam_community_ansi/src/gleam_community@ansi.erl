    ...
    run(
        ...
        code(
            [38,
                2,
                begin
                    _pipe = gleam@bitwise:shift_right(Colour@1, 16),
                    gleam@bitwise:'and'(_pipe, 16#ff)
                end,
                begin
                    _pipe@1 = gleam@bitwise:shift_right(Colour@1, 8),
                    gleam@bitwise:'and'(_pipe@1, 16#ff)
                end,
                gleam@bitwise:'and'(Colour@1, 16#ff)],
            39
        )
    ).
    ...
    run(
        ...
        code(
            [48,
                2,
                begin
                    _pipe = gleam@bitwise:shift_right(Colour, 16),
                    gleam@bitwise:'and'(_pipe, 16#ff)
                end,
                begin
                    _pipe@1 = gleam@bitwise:shift_right(Colour, 8),
                    gleam@bitwise:'and'(_pipe@1, 16#ff)
                end,
                gleam@bitwise:'and'(Colour, 16#ff)],
            49
        )
    ).
